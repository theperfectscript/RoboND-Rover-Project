...
def create_output_images(Rover):
      ...
      cv2.putText(map_add,"  Collected: "+str(Rover.samples_collected), (0, 85),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"  Sees Rock: "+str(Rover.sees_sample), (0, 100),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"  Rock Distance: "+str(Rover.sample_distance), (0, 115),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"  Rock Angle: "+str(Rover.sample_angle * 180/np.pi), (0, 130),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
